  ...
  return (
    <div className="WebProject" id="Projects">
      <div className="content-container">
        ...
        <p>
          Check out <strong>PrimeCRM</strong>, created with React and Typescript
          for dynamic interactivity, and styled with Sass and TailwindCSS for an
          attractive design. Designed to fit all devices, it provides a smooth
          and engaging user experience regardless of screen size.
        </p>
      ...
      <div className="content-illustration">
        ...
        />
        <img
          src={`${config.image_base}/assets/images/primeCRM/PrimeCRM_mobile.png`}
          alt="primeCRM mobile"
        />
        <img
