  ...
  return (
    <div className="WebProject2">
      ...
      >
        ...
        <p>
          Dive into
          <strong> Pages</strong>, a fusion of modern technology and intuitive
          design. Built with React and Typescript for optimal performance and
          styled with Sass and TailwindCSS for a captivating aesthetic. It
          offers smooth navigation and dynamic interactions, regardless of the
          device used
        </p>
        <div className="cta-container">
          <button>
            <span>
              <a
                target="_blank"
                href="https://thinoapp.github.io/WEEKLY_DECEMBER_FRONT_2/"
              >
                Live view
              </a>
            </span>
          ...
          <button>
            <a
              target="_blank"
              href="https://github.com/ThinoApp/WEEKLY_DECEMBER_FRONT_2.git"
            >
              GitHub Link
            </a>
